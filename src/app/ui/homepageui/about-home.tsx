    ...
    return (
        <section className="flex flex-col gap-12 mt-20 dark:bg-zinc-800 p-8">
            ...
            <div className="flex flex-col gap-8">
                ...
                />
                <p className={`${mont.className} dark:text-white`}>I'm Gabriel, and I'm not your traditional developer. I have 7+ years in the fitness industry, developing excellent customer service and soft skills.
