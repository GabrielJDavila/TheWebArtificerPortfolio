        ...
        <div className="flex h-full flex-col md:px-2 ml-auto">
            <div className="fixed z-40 w-full flex justify-center items-center font-mono p-2 md:pt-2 md:pb-0 md:px-0">
                ...
                >
                    ...
                    <div className="flex flex-col gap-4 items-center justify-left text-left mr-auto border-b-2 border-gray-700 pb-2">
                        <div className="flex flex-row justify-left items-center text-left gap-4 mr-auto">
                            ...
                            <ChevronDownIcon onClick={handleServicesClick} className={`w-4 text-black rounded md:hidden dark:text-white transition-all ${openServicesNav ? "rotate-180" : "rotate-0"}`}/>
                        </div>
                        {openServicesNav &&
                        <div className="flex flex-col justify-left items-center text-left gap-2 mr-auto">
                            <Link href="/services/service-one" className="text-left mr-auto">Custom Software</Link>
                            <Link href="/services/service-two" className="text-left mr-auto">Web Development</Link>
                            <Link href="/services/service-three" className="text-left mr-auto">Website Management & Hosting</Link>
                        </div>
                        }
                    </div>
                ...
                >
                    ...
                    <Link href="/services" className="text-black cursor-pointer border-b-2 border-gray-300 pb-2 text-lg hover:underline hover:underline-offset-8">Services</Link>
